...
--input.registerhotkey(5, togglehitboxdisplay) -- Has to be here or script crashes
...
function hitboxes.disable() 
 	display = false
end

function hitboxes.display() 
 	display = true
 	globals.draw_pushboxes = false
 	globals.draw_throwable_boxes = false
end

function hitboxes.displayPushboxes() 
	globals.draw_pushboxes = true
end

function hitboxes.displayThrowable() 
	globals.draw_throwable_boxes = true
end
